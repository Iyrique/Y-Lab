...
public class Main {
    ...
    private static void bookWorkspace() {
        ...
        try {
            bookingService.addBooking(currentUser.getUsername(), id, startTime, endTime, true);
    ...
    private static void bookConferenceRoom() {
        ...
        LocalDateTime endTime = LocalDateTime.parse(endTimeStr, DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm"));
        try {
            bookingService.addBooking(currentUser.getUsername(), id, startTime, endTime, false);
    ...
    private static void addNewWorkspace() {
        ...
        String name = scanner.nextLine();
        resourceService.addWorkspace(name);
    ...
    private static void addNewConferenceRoom() {
        ...
        String name = scanner.nextLine();
        resourceService.addConferenceRoom(name);
    ...
    private static void updateWorkspace() {
        ...
        resourceService.updateWorkspace(id, newName);
    ...
    private static void updateConferenceRoom() {
        ...
        System.out.print("New name: ");
        String newName = scanner.nextLine();
        resourceService.updateConferenceRoom(id, newName);
